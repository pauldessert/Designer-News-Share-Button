...
(function () {
	...
	var dnLink = document.getElementById('dn-share-button');
	...
	//dnImage.src = "data:image/png;base64, ";
	dnImage.width = "20";
	dnImage.height = "20";
	...
	style.type = 'text/css';
	style.innerHTML = '#dn-share-button span { background: #fff; border: 1px solid #d1d1d1; font-weight: normal; height: 20px; margin-left: 1px; min-width: 20px; padding: 1px 2px 1px 2px; text-align: center; line-height: 14px; font-family: "lucida grande",verdana,sans-serif; font-size: 11px; } a#dn-share-button { text-decoration: none; vertical-align: text-bottom;} #dn-share-button img {vertical-align: sub;}';
	document.getElementsByTagName('head')[0].appendChild(style);
	
	//Insert the image in the DOM
	dnLink.insertBefore(dnImage, dnLink.firstChild);

	//Check browser compatability. Return appropriate method
	(function (element, evnt, funct){
		if (document.attachEvent)
			return document.attachEvent('on'+evnt, funct);
		else
			return document.addEventListener(evnt, funct, false);
	})
})();
